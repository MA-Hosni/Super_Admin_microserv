...
import { validateReset } from "@/helpers/resetPasswordValidator";
    ...
    <div className={style.container}>
      ...
      <div className={style.form_container}>
        ...
        <div className={style.title_container}>
          <p className={style.title}>Choose a new password</p>
          <span className={style.subtitle}>Create a new password that is at least 8 characters long. A strong password is combination of letters, numbers, and punctuation marks.</span>
        </div>
        <br />
        ...
        <div className={style.input_container}>
          ...
          />
          <div className="absolute top-9 right-5 cursor-pointer" onClick={() => setPwdVisible(!pwdVisible)} >
